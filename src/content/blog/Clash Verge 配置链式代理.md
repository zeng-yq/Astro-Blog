...
function main(config) {
  ...
  const staticProxyConfig = {
    name: "🔒 静态IP (出口)",
    server: "xxxx.xxxx.xxxx.xxxx", // 替换为你的静态 IP 地址
    port: xxx, // 替换为你的端口号
    username: "xxxxxx", // 替换为你的用户名
    password: "xxxxxx", // 替换为你的密码
    type: "socks5",
    udp: true,
  };
  // =========================================================
